                                    ...
                                    <td>
                                      <div className="btn-group ml-1">
                                        ...
                                        <div className="dropdown-menu">
                                          <a className="dropdown-item" href="test-detail.php">View</a>
                                          <a className="dropdown-item" href="#_" data-toggle="modal" data-target="#inactivate">Inactive</a>
                                          <a className="dropdown-item" href="edit-test.php">Edit</a>
                                        </div>
                                      </div>
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td>
                                      <div className="btn-group ml-1">
                                        ...
                                        <div className="dropdown-menu">
                                          <a className="dropdown-item" href="test-detail-inactive.php">View</a>
