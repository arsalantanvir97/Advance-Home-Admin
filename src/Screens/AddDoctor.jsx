          ...
          <div className="col-12 mb-5">
            <div className="row">
              <div className="col-lg-6">
                <a href="doctor.php">
                  <h1 className="ml-1 main-heading"><i className="fas fa-angle-left mr-1" />Doctor Add</h1>
                </a>
              </div>
            ...
            <form action="doctor.php">
              ...
              <div className="row">
                ...
                <div className="col-lg-4 mt-2">
                  <label htmlFor className="site-labell">Experience*</label>
                  <input type="text" className="all-inputt w-100" placeholder="Enter Experience" />
                </div>
              </div>
              <div className="row">
                <div className="col-lg-4 mt-2">
                  <label htmlFor className="site-labell">Home Address*</label>
                  <input type="text" className="all-inputt w-100" placeholder="Enter Home Address" />
                </div>
                <div className="col-lg-4 mt-2">
              ...
              <div className="row">
                <div className="col-12">
                  <button type="button" data-toggle="modal" data-target="#useractivated" className="general-btn mt-3 px-3">Add</button>
                </div>
              </div>
            </form>
          </div>
