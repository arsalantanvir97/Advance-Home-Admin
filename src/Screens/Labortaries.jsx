                ...
                <div className="col-12">
                  <div className="row">
                    ...
                    <div className="col-lg-6 text-right">
                      <a href="add-laboratory.php" className="general-btn d-inline-block">Add New</a>
                    </div>
                  </div>
                                    ...
                                    <td>
                                      <div className="btn-group ml-1">
                                        ...
                                        <div className="dropdown-menu">
                                          <a className="dropdown-item" href="laboratory-details.php">View</a>
                                          <a className="dropdown-item" href="#_" data-toggle="modal" data-target="#inactivate">Inactive</a>
                                          <a className="dropdown-item" href="edit-laboratory.php">Edit</a>
                                        </div>
                                      </div>
                                    </td>
                                  </tr>
                                  <tr>
                                    ...
                                    <td>
                                      <div className="btn-group ml-1">
                                        ...
                                        <div className="dropdown-menu">
                                          <a className="dropdown-item" href="laboratory-details-inactive.php">View</a>
