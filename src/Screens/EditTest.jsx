                  ...
                  <div className="row">
                    <div className="col-lg-6">
                      <a href="test-management.php">
                        <h1 className="ml-1 main-heading"><i className="fas fa-angle-left mr-1" />Tests Details Edit</h1>
                      </a>
                    </div>
                  ...
                  <form action="test-management.php">
                    <div className="row">
                      <div className="col-lg-4 mt-2">
                        ...
                        <input type="text" className="all-inputt w-100" defaultValue="ABC" />
                      </div>
                    </div>
                    <div className="row">
                      <div className="col-lg-4 mt-2">
                    ...
                    <div className="row">
                      <div className="col-lg-4 mt-2">
                        ...
                        <span className="position-relative">
                          ...
                          <img src="images/remove.png" alt="" className="remove-img" />
                    ...
                    <div className="row">
                      <div className="col-lg-4 mt-2">
                        ...
                        <input type="text" className="all-inputt w-100" defaultValue="$100" />
                      </div>
                    </div>
                    <div className="row">
                      <div className="col-lg-4 mt-2">
                        <label htmlFor className="site-labell">Description:</label>
                        <textarea name id className="all-inputt w-100 p-2" rows={8} defaultValue={"Lorem ipsum dolor sit amet consectetur adipisicing elit. Eaque commodi illo veritatis doloribus repellendus eum aliquid nam aut quia iure labore nobis ad odio veniam, a nisi excepturi blanditiis quisquam."} />
                      </div>
                    </div>
                    <div className="row">
